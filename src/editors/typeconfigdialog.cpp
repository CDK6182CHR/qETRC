...
TypeConfigDialog::TypeConfigDialog(TypeManager &manager_, QWidget *parent):
    QDialog(parent), manager(manager_), model(new TypeConfigModel(manager_,this))
{
    resize(600,600);
...
void TypeConfigDialog::setupLabel(QLabel *label)
{
