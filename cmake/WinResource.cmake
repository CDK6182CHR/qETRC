# This file is mainly copied from SARibbonBar
...
macro(create_win32_resource_version)
	if(MSVC) # TODO: MinGW (http://www.mingw.org/wiki/MS_resource_compiler)
		...
		set(_ext "ico")
		set(_companyname "https://github.com/CDK6182CHR/qETRC")
		set(_copyright "Copyright (C) 2024 by xep")
		set(_description "qETRC train working diagram system")
		set(cmd "_target")
		foreach(arg ${ARGN})
		...
		file(APPEND ${RC_FILE} "    BEGIN\n")
		file(APPEND ${RC_FILE} "        VALUE \"Translation\", 0x0804, 1200\n")
		file(APPEND ${RC_FILE} "    END\n")
		file(APPEND ${RC_FILE} "END\n")
